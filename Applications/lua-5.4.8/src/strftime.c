...
#undef SUNOS_EXT		/* stuff in SunOS strftime routine */
#undef VMS_EXT			/* include %v for VMS date format */
#undef HPUX_EXT		/* non-conflicting stuff in HP-UX date */
#undef POSIX_SEMANTICS		/* call tzset() if TZ changes */
#undef POSIX_2008		/* flag and fw for C, F, G, Y formats */
#undef HAVE_NL_LANGINFO	/* locale-based values */
...
#else
#if !defined(__CYGWIN__) && !defined(FUZIX)
	...
	again:
		 ...
		 */
 		case 'z':	/* time zone offset east of GMT e.g. -0600 */
			 ...
			 * secs west of GMT.  Convert to mins east of GMT.
			 */
#if defined(__hpux) || defined(__CYGWIN__) || defined(FUZIX)
			off = -timezone / 60;
#else
