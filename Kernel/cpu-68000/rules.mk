...
export CROSS_CCOPTS=-c -Os -fno-strict-aliasing -fomit-frame-pointer -fno-stack-protector -fno-PIC -fno-builtin -Wall -m68040 -I$(ROOT_DIR)/cpu-68000 -I$(ROOT_DIR)/platform/platform-$(TARGET) -I$(ROOT_DIR)/include
